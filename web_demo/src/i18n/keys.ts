export const i18nKeys = {
  ...
  batch: {
    ...
    supportsFormat: 'batch.supportsFormat',
    fileSize: 'batch.fileSize',
    resultsTitle: 'batch.resultsTitle',
  ...
  statistics: {
    ...
    macroF1: 'statistics.macroF1',
    weightedF1: 'statistics.weightedF1',
    currentModelPerformance: 'statistics.currentModelPerformance',
    actualPredicted: 'statistics.actualPredicted',
    trueNegatives: 'statistics.trueNegatives',
    truePositives: 'statistics.truePositives',
    falsePositives: 'statistics.falsePositives',
    falseNegatives: 'statistics.falseNegatives',
    wordCloud: 'statistics.wordCloud',
  },
  history: {
    title: 'history.title',
  ...
  compare: {
    ...
    fullComparisonTable: 'compare.fullComparisonTable',
    model: 'compare.model',
    improvementOver: 'compare.improvementOver',
  },
  topicsResearch: {
