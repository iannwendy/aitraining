"""Complete Round 6 Retraining with Extended Dataset.

Retrains all models on the Round 6 dataset (12,555 train samples):
1. TF-IDF + Logistic Regression
2. TF-IDF + LinearSVC
3. BiLSTM (3 seeds)
4. PhoBERT (3 seeds)

Round 6 adds 5,702 new human-labeled samples from PhoBERT-positive candidates.

Usage:
    .venv/bin/python scripts/retrain_all_models_round6.py
"""
